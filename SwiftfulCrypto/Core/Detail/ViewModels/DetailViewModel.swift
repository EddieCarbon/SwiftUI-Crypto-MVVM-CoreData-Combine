...
class DetailViewModel: ObservableObject {
    ...
    private func mapDataToStatistics(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> (oveview: [StatisticModel], additional: [StatisticModel]) {
    ...
    private func createAdditionalArray(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> [StatisticModel] {
        ...
        let pricePercentChange = coinModel.priceChangePercentage24H
        let priceChangeStat = StatisticModel(title: "24h", value: priceChange, percentageChange: pricePercentChange)
